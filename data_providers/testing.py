...
class MockDataProvider(BaseDataProvider):
    ...
    def __init__(self, data):
        ...
        :param data:
            ...
            Usually, this is a list of dicts (simulates the result of a
            SQL query, data frame from an R function, etc.).
        """
    ...
    def fetch_from_backend(self, load_keys):
        # If a load key does not appear in :py:attr:`_data`, do not
        # return any data for it.  This allows us to simulate that
        # specific case during unit tests.
        return (
            (lk, self._data[lk])
                for lk in load_keys
                if lk in self._data
